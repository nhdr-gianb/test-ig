...
* identifier[tinNo].system = "http://test.ph/fhir/Identifier/tin-id"
* identifier[tinNo].type.coding = #TAX
* identifier[sssNo].system = "http://test.ph/fhir/Identifier/sss-id"
* identifier[sssNo].type.coding = #SB
* identifier[gsisNo].system = "http://test.ph/fhir/Identifier/gsis-id"
